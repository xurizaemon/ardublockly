...
Ardublockly.init = function() {
  ...
  if (document.location.hostname != 'localhost' &&
      document.location.hostname != 'pibot.local') {
...
Ardublockly.bindActionFunctions = function() {
  ...
  ArduinoMaterial.bindClick_('button_stop', ArduinoMaterial.stopProgram);
  ...
  ArduinoMaterial.bindClick_('menu_delete',  function() {
      ...
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_stop',  function() {
      ArduinoMaterial.stopProgram();
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_example_1', function() {
      ArduinoMaterial.loadServerXmlFile('examples/tiddlybotBlink.xml');
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_example_2', function() {
      ArduinoMaterial.loadServerXmlFile('examples/tiddlybotButton.xml');
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_example_3', function() {
      ArduinoMaterial.loadServerXmlFile('examples/tiddlybotUltrasound.xml');
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_example_4', function() {
      ArduinoMaterial.loadServerXmlFile('examples/tiddlyQuestion.xml');
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_example_5', function() {
      ArduinoMaterial.loadServerXmlFile('examples/tiddlybotMusic.xml');
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_example_6', function() {
      ArduinoMaterial.loadServerXmlFile('examples/TiddlyFireBot.xml');
      $('.button-collapse').sideNav('hide'); });
  ArduinoMaterial.bindClick_('menu_example_7', function() {
      ArduinoMaterial.loadServerXmlFile('examples/tiddlybotLineFollower.xml');
      $('.button-collapse').sideNav('hide'); });
...
Ardublockly.saveXmlFile = function() {
  // TiddlyBot had changed this to always use 'tiddlybot.xml'.
  var filename = document.getElementById('sketch_name').value || 'tiddlybot';
...
ArduinoMaterial.sendCode = function() {
  Materialize.toast('Sending code to the robot...', 4000);
...
ArduinoMaterial.stopProgram = function() {
  ArduServerCompiler.stopSketchOnServer(ArduinoMaterial.sendCodeReturn);
};
